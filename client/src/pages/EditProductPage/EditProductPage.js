...
function EditProductPage() {
        ...
        const fetchProduct = async () => {
            try {
                ...
                const mockProduct = {
                    ...
                    description: "Tai nghe không dây cao cấp với công nghệ chống ồn và thời lượng pin dài",
                    price: 49.99,
                    originalPrice: 79.99,
                    category: 1,
                    images: [
                        "https://via.placeholder.com/200x200?text=Tai+nghe+1",
                        "https://via.placeholder.com/200x200?text=Tai+nghe+2"
                    ],
                    stock: 100,
                    features: [
                        "Chống ồn chủ động",
                ...
                setProduct({
                    ...
                    features: mockProduct.features.length > 0 ? mockProduct.features : [''],
    ...
    const validateForm = () => {
        ...
        if (existingImages.length === 0 && product.images.length === 0) {
                    ...
                    {existingImages.length > 0 && (
                        <div className={cx('image-preview')}>
                            ...
                            {existingImages.map((url, index) => (
                                <div key={`existing-${index}`} className={cx('preview-item')}>
                    ...
                    {previewImages.length > 0 && (
                        <div className={cx('image-preview')}>
                            ...
                            {previewImages.map((url, index) => (
                                <div key={`new-${index}`} className={cx('preview-item')}>
